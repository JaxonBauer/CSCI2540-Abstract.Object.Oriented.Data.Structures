...
public class ExtendedCircle 
{
	...
	public Object shift(int x, int y)
	{
		...
		center.x = center.x + x;
		center.y = center.y + y;
		return new ExtendedCircle(this.getRadius(), center);
	}
	...
	{
		return new ExtendedCircle(this.getRadius() * size, center);
	}
	 ...
	 * @return boolean value telling if an object is equal to a given circle
	 */
	...
	public boolean equals(Object other)
	{
		this.getCenter();
		this.getRadius();
		if((this.getCenter()).equals(((ExtendedCircle) other).getCenter()) && other instanceof ExtendedCircle)
		{
			return true;
		}
		else
