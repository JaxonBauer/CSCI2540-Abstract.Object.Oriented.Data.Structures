...
public class ExtendedCircleTest 
{
	public static void main (String arg[])
	{
		...
		System.out.println(String.format("Scaling Circle #1 by 0.5, we get: \n\n" + r1.scale(0.5)));
		System.out.println(String.format("Scaling Circle #2 by 4.0, we get: \n\n" +  r2.scale(4)));
		System.out.println(String.format("Scaling Circle #3 by 0.1, we get: \n\n" + r3.scale(0.1)));
		System.out.println(String.format("Scaling Circle #4 by 10.0, we get: \n\n" + r4.scale(10)));
		System.out.println(String.format("Scaling Circle #5 by 7.5, we get: \n\n" + r5.scale(7.5)));
		System.out.println(String.format("Scaling Circle #6 by 2.5, we get: \n\n" + r6.scale(2.3)) + "\n");
